...
function Ticket() {
    ...
    let fetchData = async () => {
        try {
            let res = await axios.get(
                `https://flight-m11g.onrender.com/api/ticket/ticket/${localStorage.getItem("userid")}/${params.ticketid
                }`,
                {
                    headers: {
    ...
    let emailNow = async () => {
        ...
        try {
            let res = await axios.post("https://flight-m11g.onrender.com/api/mail/message", {
                mailid,
                ...ticket,
            });
